...
Quantitative and qualitative results suggest that the development pipeline proposed by Grenning\cite{TDDEC} is a valuable alternative to a traditional way of coding, where production code is written before tests; researchers could be interested in further studying this pipeline (\ie ``\textit{The Embedded TDD Cycle}") by exploiting field studies. 
