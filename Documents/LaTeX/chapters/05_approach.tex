...
For the same reason, the average number of tests written is lower (5.4 average for \textit{G2} compared to the 9 average for \textit{G1}); the maximum value, however, is still higher for \textit{G2}, possibli resulting from a participant "correctly" and fully applying \tdd to all user stories of the task.
...
In the task developed for \textit{Exp2}, on the other hand, (see tables \ref{tab_dv_t1} and figure \ref{box_plots_task3}), we see something much more in line with the first experimental task, with results slightly in favor of \tdd.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.33\textwidth}
        ...
        \label{bp_task3_loc}
    \end{subfigure}
    \caption{Box plots for \textit{Exp2}.}
