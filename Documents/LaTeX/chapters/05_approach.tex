...
Following these experiments, we extracted some metrics from the submitted implementations according to the defined research questions and dependent variable, by running the acceptance test suite we prepared for each task on the implementations delivered by the participants.
