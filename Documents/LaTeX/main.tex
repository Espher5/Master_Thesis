...
\input{sections/list_of_abbreviations.tex}
...
\begin{document}
    ...
    \input{sections/list_of_tables.tex}
    ...
    \begin{appendices}
        \includepdf[pages=-,scale=.8,pagecommand={},linktodoc=true]{appendix/experimental_tasks/intelligent_office_tdd.pdf}
    \end{appendices}
