The simplest way of approaching the search problem is by iteratively determining a coverage goal (i.e. a particular branch), and executing the GA to find a test case that achieves this coverage. 
