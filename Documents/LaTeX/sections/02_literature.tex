EvoSuite is an example of an evolutionary algorithm that optimizes a test suite towards just one coverage criterion, rather than generating test cases directed towards multiple coverage criteria.
