...
from deepjanus.core.seed_pool_impl import SeedPoolFolder, SeedPoolRandom
...
from deepjanus.self_driving.beamng_individual import BeamNGIndividual
from deepjanus.self_driving.beamng_individual_set_store import BeamNGIndividualSetStore
from deepjanus.self_driving.beamng_member import BeamNGMember
from deepjanus.self_driving.road_generator import RoadGenerator
...
class BeamNGProblem(Problem):
    ...
    def _get_evaluator(self):
        ...
        if ev_name == BeamNGConfig.EVALUATOR_FAKE:
            from deepjanus.self_driving.beamng_evaluator_fake import BeamNGFakeEvaluator
            self._evaluator = BeamNGFakeEvaluator(self.config)
        elif ev_name == BeamNGConfig.EVALUATOR_LOCAL_BEAMNG:
            from deepjanus.self_driving.beamng_nvidia_runner import BeamNGNvidiaOob
            self._evaluator = BeamNGNvidiaOob(self.config)
        elif ev_name == BeamNGConfig.EVALUATOR_REMOTE_BEAMNG:
            from deepjanus.self_driving.beamng_evaluator_remote import BeamNGRemoteEvaluator
